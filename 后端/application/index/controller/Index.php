...
{   //关键词舆情分析
    public function index()
    {
        ...
        $cmd = 'cd /www/wwwroot/haocibuni.zhangfanglue.com/public/python/keyword_spider/sina/spiders; 
  ...
  //      $myfile = fopen("/www/wwwroot/haocibuni.zhangfanglue.com/public/python/wordCloud/txt/".$openId.$timestamp.".txt", "w") or die("Unable to open file!");
  //      $txt = "";
  //      fwrite($myfile, $txt);
		// fclose($myfile);
		
		$myfile = fopen("/www/wwwroot/haocibuni.zhangfanglue.com/public/python/wordCloud/txt/".$openId.$timestamp.".txt", "a+") or die("Unable to open file!");
        ...
        fclose($myfile);
        $cmd2 = "cd /www/wwwroot/haocibuni.zhangfanglue.com/public/python/wordCloud; python3 wordCloud.py ".$openId.$timestamp;
    	exec($cmd2);
    ...
    public function analyse()
    {
        ...
        $cmd =  'cd /www/wwwroot/haocibuni.zhangfanglue.com/public/python/weibopage_spider/sina/spiders;
